...
class Skills extends Component
{
    use WithPagination;
    public Skill $skill;
    public $breadcrumb = 'Competências';
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Essay\Skill"; //Model principal
    ...
    {
        return view('livewire.admin.essay.skill', [
    ...
    //UPDATE
    public function showModalUpdate(Skill $Skill)
    {
        $this->resetAll();

        $this->model_id         = $Skill->id;
