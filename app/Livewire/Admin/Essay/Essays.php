...
class Essays extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Essay\Essay"; //Model principal
    ...
    {
        return view('livewire.admin.essay.essay', [
    ...
    //UPDATE
    public function showModalUpdate(Essay $essay)
    {
        $this->resetAll();

        $this->model_id         = $essay->id;
