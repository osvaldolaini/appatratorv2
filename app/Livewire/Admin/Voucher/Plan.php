...
class Plan extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Voucher\Plans"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'title,qtd,qtd_days,unity,active';
    ...
    {
        return view('livewire.admin.voucher.plans', [
    ...
    //UPDATE
    public function showModalUpdate(Plans $plans)
    {
        $this->resetAll();

        $this->model_id         = $plans->id;
        $this->title            = $plans->title;
        $this->unity            = $plans->unity;
        $this->qtd              = $plans->qtd;
