...
use App\Models\Admin\PropertyConfig\PropertyType;
...
class Types extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\PropertyConfig\PropertyType"; //Model principal
    ...
    {
        return view('livewire.admin.property-configs.types', [
    ...
    //UPDATE
    public function showModalUpdate(PropertyType $propertyType)
    {
        $this->resetAll();

        $this->model_id         = $propertyType->id;
