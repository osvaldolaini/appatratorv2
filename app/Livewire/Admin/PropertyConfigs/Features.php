...
use App\Models\Admin\PropertyConfig\PropertyFeatures;
...
class Features extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\PropertyConfig\PropertyFeatures"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'title,active,category';
    ...
    {
        return view('livewire.admin.property-configs.features', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = PropertyFeatures::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(PropertyFeatures $propertyFeatures)
    {
        $this->resetAll();

        $this->model_id         = $propertyFeatures->id;
        $this->title            = $propertyFeatures->title;
        $this->category         = $propertyFeatures->category;
