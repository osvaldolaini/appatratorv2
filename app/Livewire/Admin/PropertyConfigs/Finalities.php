...
namespace App\Livewire\Admin\PropertyConfigs;

use App\Models\Admin\PropertyConfig\PropertyFinality;
use Livewire\Component;

use Illuminate\Support\Facades\Auth;
use Livewire\WithPagination;

class Finalities extends Component
{
    use WithPagination;
    public PropertyFinality $propertyFinality;
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\PropertyConfig\PropertyFinality"; //Model principal
    ...
    //Title
    public $breadcrumb_title = 'Características';

    public function render()
    {
        return view('livewire.admin.property-configs.finalities', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = PropertyFinality::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(PropertyFinality $propertyFinality)
    {
        $this->resetAll();

        $this->model_id         = $propertyFinality->id;
        $this->title            = $propertyFinality->title;
    ...
    public function update()
    {
        ...
        PropertyFinality::updateOrCreate([
            'id' => $this->model_id,
        ], [
            'title'      => $this->title,
