...
namespace App\Livewire\Admin\Treinament;
...
class Exercises extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Treinament\Exercise"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'id,title,active,unity';
    ...
    {
        return view('livewire.admin.treinament.exercise', [
    ...
    //UPDATE
    public function showModalUpdate(Exercise $Exercise)
    {
        $this->resetAll();

        $this->model_id         = $Exercise->id;
        $this->title            = $Exercise->title;
        $this->unity            = $Exercise->unity;
