...
class Offices extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\Office"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.office', [
    ...
    //UPDATE
    public function showModalUpdate(Office $office)
    {
        $this->resetAll();

        $this->model_id         = $office->id;
        $this->title            = $office->title;
        $this->nick            = $office->nick;
