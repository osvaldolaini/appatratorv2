...
class Institutions extends Component
{
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'instituições';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\Institution"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.institution', [
    ...
    //UPDATE
    public function showModalUpdate(Institution $institution)
    {
        $this->resetAll();

        $this->model_id         = $institution->id;
        $this->title            = $institution->title;
        $this->nick             = $institution->nick;
