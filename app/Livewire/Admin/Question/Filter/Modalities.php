...
class Modalities extends Component
{
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'modalidades';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\Modality"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'title,nick,qtd,active';
    ...
    {
        return view('livewire.admin.questions.filters.modality', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = Modality::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(Modality $modality)
    {
        $this->resetAll();

        $this->model_id         = $modality->id;
        $this->title            = $modality->title;
        $this->nick             = $modality->nick;
        $this->qtd              = $modality->qtd;
