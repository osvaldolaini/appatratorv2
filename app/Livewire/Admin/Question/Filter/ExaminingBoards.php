...
class ExaminingBoards extends Component
{
    use WithPagination;
    public ExaminingBoard $examiningBoard;
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\ExaminingBoard"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.examiningBoard', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = ExaminingBoard::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(ExaminingBoard $examiningBoard)
    {
        $this->resetAll();

        $this->model_id         = $examiningBoard->id;
        $this->title            = $examiningBoard->title;
        $this->nick            = $examiningBoard->nick;
