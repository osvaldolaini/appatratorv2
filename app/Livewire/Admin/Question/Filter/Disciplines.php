...
class Disciplines extends Component
{
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'disciplinas';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\Discipline"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.discipline', [
    ...
    //UPDATE
    public function showModalUpdate(Discipline $discipline)
    {
        $this->resetAll();

        $this->model_id         = $discipline->id;
        $this->title            = $discipline->title;
        $this->nick             = $discipline->nick;
