...
class EducationAreas extends Component
{
    use WithPagination;
    public EducationArea $educationArea;
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'áreas-de-formação';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\EducationArea"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'title,nick,active';
    ...
    {
        return view('livewire.admin.questions.filters.educationArea', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = EducationArea::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(EducationArea $educationArea)
    {
        $this->resetAll();

        $this->model_id         = $educationArea->id;
        $this->title            = $educationArea->title;
        $this->nick             = $educationArea->nick;
