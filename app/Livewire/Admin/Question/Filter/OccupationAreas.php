...
class OccupationAreas extends Component
{
    use WithPagination;
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'áreas-de-atuação';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\OccupationArea"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.occupationArea', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = OccupationArea::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(OccupationArea $occupationArea)
    {
        $this->resetAll();

        $this->model_id         = $occupationArea->id;
        $this->title            = $occupationArea->title;
        $this->nick            = $occupationArea->nick;
