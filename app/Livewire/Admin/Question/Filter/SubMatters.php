...
class SubMatters extends Component
{
    use WithPagination;
    public SubMatter $SubMatter;
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'sub-topicos-das-matérias';
    public $matters;

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\SubMatter"; //Model principal
    public $modelId="id"; //Ex: 'table.id' or 'id'
    public $search;
    public $relationTables; //Relacionamentos ( table , key , foreingKey )
    public $customSearch; //Colunas personalizadas, customizar no model
    public $columnsInclude = 'title,nick,matter_id,active';
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = SubMatter::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
