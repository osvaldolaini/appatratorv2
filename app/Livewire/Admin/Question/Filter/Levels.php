...
class Levels extends Component
{
    ...
    public $model_id;
    public $registerId;
    public $tabs = 'níveis-de-formação';

    //Dados da tabela
    public $model = "App\Models\Admin\Questions\Filters\Level"; //Model principal
    ...
    {
        return view('livewire.admin.questions.filters.level', [
    ...
    //UPDATE
    public function showModalUpdate(Level $level)
    {
        $this->resetAll();

        $this->model_id         = $level->id;
        $this->title            = $level->title;
        $this->nick            = $level->nick;
