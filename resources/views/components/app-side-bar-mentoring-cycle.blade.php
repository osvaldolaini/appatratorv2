<div>
    <div class="fixed drawer drawer-mobile lg:drawer-open">
        ...
        <div class="drawer-side">
            ...
            <ul
                class="menu w-80 h-full pt-2 px-1 bg-black
                        ...
                        <div class="pr-3">
                            <ul >
                                ...
                                <li class="pt-2 border-t border-gray-100">
                                    <x-mentoring-app-link active="app-de-mentoria/ciclo" href="{{ route('apps.contestControllerCycleUser.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0" fill="currentColor"
                                            viewBox="0 0 512 512"
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/planejamento-por-ciclo" href="{{ route('apps.contestPlanningCyclesUser.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
