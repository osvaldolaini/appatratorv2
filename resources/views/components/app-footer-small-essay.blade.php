    ...
    <div class="w-full h-screen lg:hidden text-gray-600 dark:text-gray-100 text-gray-500bg-gray-100 dark:bg-gray-700">
        ...
        <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
            <div id="tabs" class="flex justify-between">
                <a href="{{ route('apps.treinaments') }}" class="w-full justify-center inline-block text-center pt-2 pb-1">
                ...
                <label for="my-drawer-right"
                    class="drawer-button w-full justify-center inline-block text-center pt-2 pb-1">
                    <svg width="25" height="25" viewBox="0 0 24 24" class="inline-block mb-1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="tab tab-explore block text-xs">Filtros</span>
                </label>
