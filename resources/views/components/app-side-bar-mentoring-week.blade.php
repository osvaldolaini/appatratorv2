...
<div>
    <div class="fixed drawer drawer-mobile lg:drawer-open">
        ...
        <div class="drawer-side">
            ...
            <ul
                class="menu w-80 h-full pt-24 sm:pt-2 px-1 bg-black
                        ...
                        <div class="pr-3">
                            <ul >
                                    ...
                                    <x-mentoring-app-link active="app-de-mentoria" href="{{ route('apps.mentorings') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0" fill="none"
                                ...
                                <li class="pt-2 border-t border-gray-100">
                                    <x-mentoring-app-link active="app-de-mentoria/planejamento-da-semana" href="{{ route('apps.contestPlanningWeekUser.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/tarefas-diárias*" href="{{ route('apps.contestPlanningTasksUser.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/meu-planejamento*" href="{{ route('apps.contestPlanningUser.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 1 0-9 9m0-14v3.764a2 2 0 0 0 1.106 1.789L16 14m3 2v3m0 3v-3m0 0h-3m3 0h3"/>
                                            </svg>
                                        </x-slot>
                                ...
                                <li>
                                    <x-mentoring-app-link active="meu-concurso" href="{{ route('apps.contest.user') }}">
                                        <x-slot name="svg">
                                            ...
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h5m3 0h2m0 4h-6m-3 0H7m0 4h5m3 0h2M3 8V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8z"/>
                                            </svg>
                                        </x-slot>
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/questões" href="{{ route('apps.contestQuestionsChart.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 8h2m-2 4h2m-5 4H7m14-4V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7M7 8v4h4V8H7z"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.268 19.268a2.5 2.5 0 1 0-3.536-3.536 2.5 2.5 0 0 0 3.536 3.536zm0 0L21 21"/>
                                            </svg>
                                        </x-slot>
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/simulados" href="{{ route('apps.contestSimulateds.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <x-mentoring-app-link active="app-de-mentoria/redações" href="{{ route('apps.contestEssays.user') }}">
                                        <x-slot name="svg">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-8 w-8 opacity-75 opacity-100 group-hover:opacity-0"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
