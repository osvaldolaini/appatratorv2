<div class="w-100">
    <div class="bg-white dark:bg-gray-800 pt-3 sm:rounded-lg">
        <livewire:admin.search-bar.search-bar
            {{-- REQUIRED --}} model="App\Models\Admin\SocialMedias" {{-- Model principal --}}
            {{-- REQUIRED --}} modelId="id" {{-- Ex: 'table.id' or 'id' --}}
            {{-- REQUIRED --}} showId="false" {{-- 'true' or 'false' --}}
            {{-- REQUIRED --}} columnsInclude="title,media" {{-- Colunas incluidas --}}
            {{-- REQUIRED --}} columnsNames="Nome,Mídia social" {{-- Cabeçalho da tabela --}}
            {{-- REQUIRED --}} searchable="title,media" {{-- Colunas pesquisadas no banco de dados --}}
                {{-- OK --}}   customSearch="media" {{-- Colunas personalizadas, customizar no model --}}
                ...
                {{-- OK --}}   sort="title , desc" {{-- Ordenação da tabela --}}
                ...
                <div class="grid gap-4 mb-1 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" wire:model="link"
                            placeholder="Link da rede social" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('link')
                            <span class="error">{{ $message }}</span>
                        @enderror
