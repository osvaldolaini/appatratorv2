            ...
            <div class="col-span-2 justify-items-end">
                <div class="w-full">
                    <div class="flex justify-end font-medium duration-200 ">
                        <div class="tooltip tooltip-top p-0" data-tip="Disciplina">
                            <a href="{{ route('contestDiscipline', $contest_discipline_id) }}"
            ...
            <form wire:submit="store">
                <div class="grid gap-4 mb-1 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-4">
                        ...
                        <input type="text" wire:model="title" name="title" id="title" placeholder="Título"
                            required=""
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="order"
                            class="block text-sm font-medium text-gray-900 dark:text-white">*Ordem</label>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="order_title"
                            class="block text-sm font-medium text-gray-900 dark:text-white">*Número</label>
                        <input type="text" wire:model="order_title" name="order_title" id="order_title"
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="nick"
                            class="block text-sm font-medium text-gray-900 dark:text-white">Sigla</label>
                        <input type="text" wire:model="nick" name="nick" id="nick" placeholder="Sigla"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('nick')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="level"
                            class="block text-sm font-medium text-gray-900 dark:text-white">Incidência</label>
                        <select wire:model="level" name="level"
                            id="level"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
