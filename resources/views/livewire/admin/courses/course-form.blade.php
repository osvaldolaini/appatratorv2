<div>
    ...
    <section class="px-4 dark:bg-gray-800 dark:text-gray-50 container flex flex-col mx-auto space-y-12">
        <form @if ($title) wire:submit="update" @else wire:submit="create" @endif>
            <fieldset class="grid grid-cols-12 gap-2 pb-6 rounded-md dark:bg-gray-900 items-start">
                <div class="col-span-full sm:col-span-12">
                    ...
                    <input
                        ...
                        placeholder="Nome do curso" wire:model="title" required="true" maxlength="100">
                    @error('title')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-span-full sm:col-span-6">
                    <label for="see_value">ID do preço STRIPE</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="ID do preço STRIPE" wire:model="price_id">
                </div>

                <div class="col-span-full sm:col-span-6">
                    <label for="highlighted">Em destaque? </label>
                ...
                <div class="col-span-full sm:col-span-6">
                    <label for="youtube_link">Link vídeo de divulgação</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Link youtube" wire:model="youtube_link" maxlength="100">
                </div>

                <div class="col-span-full sm:col-span-6">
                    <label for="link">Link hotmart</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Link hotmart" wire:model="link" maxlength="100">
                </div>

                <div class="col-span-full sm:col-span-6">
                    <label for="meta_description">*Descrição simples(150 caracteres)</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        maxlength="150" wire:model="meta_description" rows="5" required>{{ old('meta_description', $data->meta_description ?? '') }}</textarea>
                </div>
                <div class="col-span-full sm:col-span-6">
                    <label for="meta_tags">Palavras chave (80 caracteres)</label>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        maxlength="80" wire:model="meta_tags" rows="5">{{ old('meta_tags', $data->meta_tags ?? 'As palavras chaves devem ser separadas por ","') }}</textarea>
                </div>
