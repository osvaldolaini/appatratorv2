        ...
        <x-slot name="content">
            <form wire:submit="store">
                <div class="grid gap-4 mb-1 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="col-span-2 ">
                        <label for="acronym" class="block text-sm font-medium text-gray-900 dark:text-white">
                            *Sigla</label>
                        <input type="text" wire:model="acronym" placeholder="Sigla" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('acronym')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-2 ">
                        <label for="master" class="block text-sm font-medium text-gray-900 dark:text-white">
                            *Grupo</label>
                        <select wire:model="master"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
