            ...
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">PDF, DOCX, XLSX, ETC...</p>
                    </div>
                    <div class="col-span-1" x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                        ...
                        <div x-show="isUploading">
                            <progress x-bind:value="progress" class="progress progress-primary w-56" value="0"
                                max="100"></progress>
                        </div>
                        ...
                        <div class="card-body items-center text-center">
                            <h2 class="card-title">
                                @switch($document->ext)
                                    ...
                                    <svg class="w-5 h-5 mr-1 -ml-1" fill="currentColor" viewBox="0 0 482.139 482.139"
                                        xml:space="preserve">
                                        <g>
                                            <path
                                    ...
                                    @case('pdf')
                                        <svg class="w-5 h-5 mr-1 -ml-1" fill="currentColor" viewBox="0 0 550.801 550.801"
                                            xml:space="preserve">
                                            <g>
                                                <path
                                    ...
                                    @case('xlsx')
                                        <svg class="w-5 h-5 mr-1 -ml-1" fill="currentColor" viewBox="0 0 548.291 548.291"
                                            xml:space="preserve">
                                            <g>
                                    ...
                                    @case('csv')
                                        <svg class="w-5 h-5 mr-1 -ml-1" fill="currentColor" viewBox="0 0 548.29 548.291"
                                            xml:space="preserve">
                                            <g>
