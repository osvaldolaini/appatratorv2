    ...
    <div class="py-3 px-1 border border-gray-200 dark:border-gray-700 dark:bg-gray-900">
        <div class="grid grid-cols-8 gap-2 mx-2 ">
            <div class="col-span-full sm:col-span-1" wire:ignore>
                @livewire('admin.course.contents.upload-image', [$content->id])
            </div>
            <div class="text-left col-span-full sm:col-span-4 pl-2">
                <div>
                    <h1 class="text-3xl font-bold">{{ $content->title }}</h1>
                    <div class="max-w-xs" id="{{ $content->id }}-contentDescription">
                        <p>
            ...
            <div class="col-span-full sm:col-span-3">
                <div class="block space-x-2 space-y-2 justify-start font-medium duration-200 ">
                    {{-- @if ($content->active == 1)
                    <button wire:click="buttonActive({{ $content->id }})"
                ...
                @endif --}}
                    <a href="{{ route('content-module', $content->id) }}" class="btn btn-outline btn-sm">Editar
                    ...
                    <button wire:click="showModalDelete({{ $content->id }})" class="btn btn-outline btn-sm">Apagar
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    {{-- <button wire:click="showModalRead({{ $content->id }})"
                ...
                <svg stroke="currentColor" class="w-5 h-5 sm:w-6 sm:h-6"
                    ...
                    <button wire:click="modalOrder({{ $content->id }})" class="btn btn-outline btn-sm">Ordenar
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 7L7 7M20 7L11 7" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                            <path d="M20 17H17M4 17L13 17" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                    ...
                    @switch($content->type_content)
                        @case('video')
                            <div class="btn btn-outline btn-success btn-sm">Tipo: Vídeo
                        ...
                        @case('download')
                            <div class="btn btn-outline btn-primary btn-sm">Tipo: Download
                                <svg class="h-6 w-6 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        @case('text')
                            <div class="btn btn-outline  btn-sm">Tipo: Texto
                                <svg class="h-6 w-6 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 3V21M9 21H15M19 6V3H5V6" stroke="currentColor" stroke-width="2"
