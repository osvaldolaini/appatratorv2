<div class="w-100 min-h-screen">
    <h1 class="text-5xl font-extrabold dark:text-white text-center">
        <small class="ml-2 font-semibold text-gray-500 dark:text-gray-400">
            Treinos realizados para {{ $season_title }} </small>
    </h1>
        ...
        <div class="overflow-hidden sm:rounded-lg mb-5">
            <div class="grid grid-cols-2 gap-4 px-4 py-2" id="season" wire:model="season">
                ...
                @foreach ($seasonTreinaments as $item)
                    <div
                        class="flex-col sm:flex-row sm:col-span-1 col-span-2 hover:bg-gray-200 flex my-1 mx-2 p-1 sm:p-2 text-xs sm:text-sm bg-gray-100 text-gray-500 dark:text-gray-50 border overflow-hidden rounded-lg
                                                border-gray-200  dark:bg-gray-800 dark:border-gray-700 shadow-md ">
