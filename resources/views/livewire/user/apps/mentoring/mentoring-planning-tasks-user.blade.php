                        ...
                        <div class="collapse-content p-0">
                            @foreach ($planning->daily->sortBy('order') as $daily)
                                <div
                                    ...
                                    <div class="card-body p-2 pl-3 gap-0 text-xs rounded-md bg-white
                                    ml-1 mb-1">
                                                    ...
                                                    <div class="inline-block min-w-full align-middle md:px-6 lg:px-8">
                                                        <div class="overflow-hidden dark:border-gray-700 ">
                                                            <table style="width:100%"
                                                                class='min-w-full rounded-md divide-y divide-gray-200 dark:divide-gray-700'>
                                                                {{-- Table head --}}
                                                                <thead
                                                                    class="bg-gray-200 rounded-md dark:bg-gray-800 text-gray-500 dark:text-gray-400 ">
                                                                    <tr>
                                                                        <th class="p-2.5">
                                                                            Assunto
                                                                        </th>
