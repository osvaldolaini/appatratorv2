            ...
            <div
                ...
                <div class="group flex ">
                    ...
                    hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                        ...
                        <span>Registrar redações </span>
                    </button>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 my-6 px-2">
            ...
            <form action="#" wire:submit.prevent="store()" wire.loading.attr='disable'>
                <div class="grid gap-4 mb-1 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                    ...
                    <div class="col-span-3 sm:col-span-1">
                        <label for="full_mark" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Nota máxima
                        </label>
                        <input type="text" wire:model="full_mark" name="full_mark" id="full_mark"
                            placeholder="Nota máxima" required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('full_mark')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-3 sm:col-span-1">
                        <label for="mark" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Minha nota
                        </label>
                        <input type="text" wire:model="mark" name="mark" id="mark"
                            placeholder="Minha nota" required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('mark')
                            <span class="error">{{ $message }}</span>
                        @enderror
