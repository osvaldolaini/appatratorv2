            ...
            <div
                ...
                <div class="group flex ">
                    ...
                    hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                        ...
                        <span>Registrar simulados </span>
                    </button>
                </div>
            </div>
        </div>

        <div class=" bg-whit900 my-6 px-4">
                                            ...
                                            @foreach ($data as $item)
                                                <tr class="hover:bg-gray-100">
                                                    ...
                                                    <td scope="col"
                                                        ...
                                                        <div class="flex mr-2">
                                                            <div class="tooltip {{ $loop->first ? 'tooltip-top ' : 'tooltip-bottom ' }}  p-0 "
                                                                data-tip="Editar">
                                                                <button wire:click="showModalEdit({{ $item->id }})"
                                                                    title="Editar"
                                                                    class="py-2 px-3 rounded-l font-medium transition-colors
                                                                text-gray-300 dark:text-gray-300 dark:hover:bg-blue-500 hover:hover:bg-blue-500
        ...
        <x-slot name="content">
            <form action="#" wire:submit.prevent="store()" wire.loading.attr='disable'>
                <div class="grid gap-4 mb-1 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                    <div class="col-span-4 " x-data x-init="Inputmask({
                        'mask': '99/99/9999'
                    }).mask($refs.day)">
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="grade" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Nota
                        </label>
                        <input type="text" wire:model="grade" name="grade" id="grade" placeholder="Acertos"
                            required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('grade')
                            <span class="error">{{ $message }}</span>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="qtd" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Qtd de questões
                        </label>
                        <input type="text" wire:model="qtd" name="qtd" id="qtd"
                            placeholder="Qtd de questões" required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('qtd')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="hits" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Acertos
                        </label>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="misses" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Erros
                        </label>
                        <input type="text" wire:model="misses" name="misses" id="misses" placeholder="Erros"
                            required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('misses')
                            <span class="error">{{ $message }}</span>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="guesses" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Chutes
                        </label>
                        <input type="text" wire:model="guesses" name="guesses" id="guesses"
                            placeholder="Chutes" required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('guesses')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="blanks" class="block text-sm font-medium text-gray-900 dark:text-white">
                            Em branco
                        </label>
                        <input type="text" wire:model="blanks" name="blanks" id="blanks"
                            placeholder="Em branco" required=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        @error('blanks')
                            <span class="error">{{ $message }}</span>
                        @enderror
