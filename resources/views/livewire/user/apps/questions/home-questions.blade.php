<div>
    ...
    <div class="drawer drawer-mobile drawer-end">
        ...
        <div class="drawer-content bg-white pb-52">
            <div class="m-5 pb-8 sm:pb-2">
                    ...
                    @if (isset($selectedFiltersMask))
                        @foreach ($selectedFiltersMask as $item)
                            <div
                                ...
                                <div data-id="{{ $item['table'] }}_{{ $item['id'] }}" onclick="removeFilter('{{ $item['table'] }}_{{ $item['id'] }}')" class=" flex flex-nowarp flex-row-reverse text-xs" wire:click="updateSelectedFilters('{{ $item['id'] }}','{{ $item['title'] }}','{{ $item['table'] }}')">
                                    {{ $item['title'] }}
                                    <svg
                                        class="fill-current h-4 w-4" role="button" viewBox="0 0 20 20">
                                        <path
        ...
        <div class="drawer-side bg-cyan-200 sm:bg-slate-100 dark:bg-slate-700 text-xs sm:text-sm w-36 sm:w-24">
            <label for="my-drawer-right" class="drawer-overlay bg-cyan-100"></label>
            {{-- @livewire('app.questions.side-bar-filters') --}}
            <div class="static text-cyan-600 dark:text-cyan-100 pt-5 ">
                <div class="grid grid-cols-2 px-2 sm:mb-3">
                    <div>
                ...
                <div class="grid grid-cols-2 px-2 sm:mb-3 block sm:hidden">
