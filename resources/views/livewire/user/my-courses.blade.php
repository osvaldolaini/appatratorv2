    ...
    <div class="flex flex-wrap sm:justify-around">
        <div class="w-full ">
            <div class="py-4 space-x-4 ">
                ...
                <h1
                    class="grid grid-cols-1 space-x-1 text-5xl font-extrabold dark:text-white text-center">
                    <small class="col-span-full ml-2 font-semibold text-gray-500 dark:text-gray-400">
                        Infelizmente você ainda não possui nenhum <span class="text-black">curso</span>
                    </small>

                </h1>
                <h1
                    class="grid grid-cols-1 space-x-1 text-2xl font-extrabold dark:text-white text-center">
                    <small class="col-span-full ml-2 font-semibold text-gray-500 dark:text-gray-400">
                        Clique no botão abaixo para adiquirir um dos nossos cursos
                    </small>
