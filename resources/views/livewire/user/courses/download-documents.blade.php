    ...
    <div class="card w-full bg-neutral text-neutral-content hover:bg-slate-400 hover:text-gray-800 cursor-pointer">
        <div class="card-body items-center text-center">
            <div class="w-full flex justify-end">
                @if ($history)
                    <svg wire:click="changeCheck()" class="me-2 shrink-0 w-5 h-5 text-green-500 cursor-pointer"
                ...
                @else
                    <svg wire:click="changeCheck()" class="me-2 shrink-0 w-5 h-5 cursor-pointer" fill="currentColor"
