            ...
            <div class="min-h-80 bg-white rounded-2xl dark:bg-gray-700 py-2">
                <nav class="mt-3">
                    <div>
                        ...
                        <div class="py-1">
                        <x-link-simple url="apps.questions" active="*app-de-questões*">
                            <span class="text-left">
